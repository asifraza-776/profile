...
const Navbar = () => {
  ...
  // Dropdown को बाहर क्लिक करने पर बंद करने के लिए
  useEffect(() => {
  ...
  return (
    <nav className='bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16'>
      <Link className="logo font-bold text-lg flex justify-center items-center" href={"/"}>
        ...
        <span className='text-xl md:text-base my-3 md:my-0'>Asif Profile!</span>
      </Link>
      ...
      <div className='relative flex justify-center items-center md:block gap-4' ref={dropdownRef}>
        {session && <>
          ...
          <div className={`z-10 ${showdropdown ? "" : "hidden"} absolute left-[15px] top-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
